...
namespace TGMTcs
{
    class TGMTcrypto
    {
        ...
        public static void EncryptFileAES(string inputFile, string outputFile, string password)
        {
        ...
        public static void DecryptFileAES(string inputFile, string outputFile, string password)
        {
